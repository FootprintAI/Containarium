...
func printUsage() {
	...
	log.Println("  CONTAINARIUM_MCP_TOOLS       - Comma-separated tool allow-list (exact names")
	log.Println("                                 and/or \"prefix_*\" globs, e.g. \"tracker_*\").")
	log.Println("                                 Unset = every tool available (default).")
	log.Println("")
