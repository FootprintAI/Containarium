...
func TestHandleToolsList(t *testing.T) {
	...
	require.True(t, ok)
	// See TestServerCreation's tally comment for the running count — 81.
	assert.Len(t, tools, 81)
